...
// {
//    Sudut = -1 * Sudut * M_PI / 180; /* Mengubah sudut dari derajat ke radian */
//    POINT old = *P;
//    Absis(*P) = Absis(old) * cos(Sudut) - Ordinat(old) * sin(Sudut);
//    Ordinat(*P) = Absis(old) * sin(Sudut) + Ordinat(old) * cos(Sudut);
// }
// /* I.S. P terdefinisi */
